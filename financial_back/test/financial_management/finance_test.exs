defmodule FinancialManagement.FinanceTest do
  use FinancialManagement.DataCase
  ...
  describe "transactions" do
    ...
    test "create_transaction/1 with valid data creates a transaction" do
      valid_attrs = %{type: "some type", value: "120.5", date: ~N[2025-05-26 00:57:00], description: "some description"}
      ...
      assert transaction.date == ~N[2025-05-26 00:57:00]
    ...
    test "update_transaction/2 with valid data updates the transaction" do
      transaction = transaction_fixture()
      update_attrs = %{type: "some updated type", value: "456.7", date: ~N[2025-05-27 00:57:00], description: "some updated description"}
      ...
      assert transaction.date == ~N[2025-05-27 00:57:00]
  ...
  describe "transactions" do
    ...
    test "create_transaction/1 with valid data creates a transaction" do
      valid_attrs = %{type: "some type", value: "120.5", date: ~N[2025-05-26 12:44:00], description: "some description"}

      assert {:ok, %Transaction{} = transaction} = Finance.create_transaction(valid_attrs)
      assert transaction.type == "some type"
      assert transaction.value == Decimal.new("120.5")
      assert transaction.date == ~N[2025-05-26 12:44:00]
      assert transaction.description == "some description"
    end
    ...
    test "update_transaction/2 with valid data updates the transaction" do
      ...
      assert transaction.type == "some updated type"
      assert transaction.value == Decimal.new("456.7")
      assert transaction.date == ~N[2025-05-27 12:44:00]
      assert transaction.description == "some updated description"
    end
